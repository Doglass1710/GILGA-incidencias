...
class MedidasExport implements FromQuery, ShouldAutoSize, WithHeadings, WithTitle, WithEvents
{
    ...
    public function query()
    {
            ...
            if($this->tipo_reporte=='solo_medidas'){
                ...
                if($this->estacion == '*'){
                    ...
                    ->whereRaw("cast(fecha_aplica as date) between cast('$this->fecha_desde' as date) and cast('$this->fecha_hasta' as date)");
